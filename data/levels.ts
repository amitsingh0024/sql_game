...
export const LEVEL_11: LevelData = {
  ...
  description: "The security layer. Authorization and adversarial correctness.",
  theme: ThemeStyle.CORE,
  missions: [
    {
      id: "L11_Q1",
      title: "UNAUTHORIZED INFLUENCE",
      story: "After the fall of the Consensus Hydra, Zero discovers realities where changes appeared valid and consistent, yet were authored by entities that should never have had influence. Identify such realities.",
      objective: "Identify realities with unauthorized influence.",
      hint: "Trust boundaries were crossed.",
      tables: [
        {
          name: "realities",
          columns: [
        ...
        },
        {
          ...
          data: [
            { update_id: 1, reality_id: 1, actor_id: 1 },
            { update_id: 2, reality_id: 2, actor_id: 2 }
          ]
        },
        {
          name: "actor_roles",
          ...
          data: [
            { id: 1, actor_id: 1, role_id: 1 },
            { id: 2, actor_id: 2, role_id: 2 }
          ]
        },
        {
          ...
          columns: [
            { name: "id", type: "number" },
            { name: "role_id", type: "number" },
            { name: "can_modify", type: "boolean" }
          ],
          data: [
            { id: 1, role_id: 1, can_modify: false },
            { id: 2, role_id: 2, can_modify: true }
          ]
        }
      ],
      expectedResult: (data) => {
        // Reality 1: actor 1 has role 1, which cannot modify
        return data.length > 0 && data.some(d => d.id === 1);
      },
      successMessage: "UNAUTHORIZED INFLUENCE IDENTIFIED. Trust boundary violations are exposed."
    },
    {
      id: "L11_Q2",
      title: "SILENT VISIBILITY BREACHES",
      story: "Pixel finds identities accessing records that were never meant to be visible to them, yet no alarms were raised. The access path appears legitimate. Identify such silent visibility breaches.",
      objective: "Identify silent visibility breaches.",
      hint: "Visibility without authorization.",
      tables: [
        {
          name: "read_logs",
          columns: [
          ...
          data: [
            { read_id: 1, actor_id: 1 },
            { read_id: 2, actor_id: 2 }
          ]
        },
        {
          name: "actor_roles",
        ...
        },
        {
          ...
          data: [
            { id: 1, role_id: 1, can_read: false },
            { id: 2, role_id: 2, can_read: true }
          ]
        }
      ],
      expectedResult: (data) => {
        // Read 1: actor 1 has role 1, which cannot read
        return data.length > 0 && data.some(d => d.read_id === 1);
      },
      successMessage: "SILENT VISIBILITY BREACHES IDENTIFIED. Unauthorized access is exposed."
    },
    {
      id: "L11_Q3",
      title: "SELECTIVE FIELD ALTERATION",
      story: "Nyx suspects that some rows were selectively altered while the surrounding data remained untouched, making the change hard to detect. Identify updates that modified only sensitive fields.",
      objective: "Identify updates that modified only sensitive fields.",
      hint: "Small changes hide well.",
      tables: [
        {
          name: "updates",
          columns: [
        ...
        },
        {
          ...
          data: [
            { id: 1, update_id: 1, field_id: 1 },
            { id: 2, update_id: 2, field_id: 2 },
            { id: 3, update_id: 2, field_id: 3 }
          ]
        },
        {
          name: "fields",
          ...
          data: [
            { field_id: 1, is_sensitive: true },
            { field_id: 2, is_sensitive: true },
            { field_id: 3, is_sensitive: false }
          ]
        }
      ],
      expectedResult: (data) => {
        // Update 1: only modified field 1 (sensitive), all fields are sensitive
        // Update 2: modified fields 2 (sensitive) and 3 (not sensitive), so not all sensitive
        return data.length > 0 && data.some(d => d.update_id === 1);
      },
      successMessage: "SELECTIVE FIELD ALTERATION IDENTIFIED. Subtle data changes are exposed."
    },
    {
      id: "L11_Q4",
      title: "HISTORICAL REWRITES",
      story: "Zero uncovers realities where historical records were subtly rewritten, yet global consistency checks passed. Identify realities where history differs across replicas but converged later.",
      objective: "Identify realities with historical rewrites.",
      hint: "Temporary lies leave scars.",
      tables: [
        {
          name: "realities",
          columns: [
        ...
        },
        {
          ...
          data: [
            { id: 1, reality_id: 1, state_hash: "hash1" },
            { id: 2, reality_id: 1, state_hash: "hash2" },
            { id: 3, reality_id: 2, state_hash: "hash3" }
          ]
        }
      ],
      expectedResult: (data) => {
        // Reality 1: has 2 different state_hash values
        return data.length > 0 && data.some(d => d.id === 1);
      },
      successMessage: "HISTORICAL REWRITES IDENTIFIED. History divergence is exposed."
    },
    {
      id: "L11_Q5",
      title: "SUPPLY CHAIN POISONING",
      story: "Pixel detects trusted components that introduced corrupted data into multiple realities simultaneously. These components never directly changed data themselves. Identify such indirect sources.",
      objective: "Identify components with supply chain poisoning.",
      hint: "Supply chains can poison.",
      tables: [
        {
          name: "supply_chain_logs",
          columns: [
            { name: "id", type: "number" },
        ...
        },
        {
          ...
          columns: [
            { name: "update_id", type: "number" },
            { name: "reality_id", type: "number" },
            { name: "source_component", type: "number" }
          ],
          data: [
            { update_id: 1, reality_id: 1, source_component: 1 },
            { update_id: 2, reality_id: 2, source_component: 1 },
            { update_id: 3, reality_id: 3, source_component: 1 },
            { update_id: 4, reality_id: 4, source_component: 1 },
            { update_id: 5, reality_id: 1, source_component: 2 }
          ]
        }
      ],
      expectedResult: (data) => {
        // Component 1: affected 4 different realities (> 3)
        // Component 2: affected 1 reality (not > 3)
        return data.length > 0 && data.some(d => d.component_id === 1);
      },
      successMessage: "SUPPLY CHAIN POISONING IDENTIFIED. Indirect corruption sources are exposed."
    },
    {
      id: "L11_Q6",
      title: "POISONED INPUTS",
      story: "Nyx notices that some changes passed every validation rule yet caused downstream systems to behave unpredictably. The issue traces back to training data corruption. Identify such poisoned inputs.",
      objective: "Identify poisoned training data inputs.",
      hint: "Correct data can still be wrong.",
      tables: [
        {
          name: "datasets",
          columns: [
            { name: "dataset_id", type: "number" },
            { name: "is_trusted", type: "boolean" }
          ],
          data: [
            { dataset_id: 1, is_trusted: true },
            { dataset_id: 2, is_trusted: false }
          ]
        },
        {
          name: "model_inputs",
          columns: [
            ...
            { name: "dataset_id", type: "number" },
            { name: "update_id", type: "number" },
            { name: "outlier_score", type: "number" }
          ],
          data: [
            { id: 1, dataset_id: 1, update_id: 1, outlier_score: 0.96 },
            { id: 2, dataset_id: 1, update_id: 2, outlier_score: 0.80 },
            { id: 3, dataset_id: 2, update_id: 3, outlier_score: 0.98 }
          ]
        },
        {
          name: "updates",
          ...
          data: [
            { update_id: 1, reality_id: 1 },
            { update_id: 2, reality_id: 2 },
            { update_id: 3, reality_id: 3 }
          ]
        }
      ],
      expectedResult: (data) => {
        // Dataset 1: is_trusted=true, has outlier_score 0.96 > 0.95
        return data.length > 0 && data.some(d => d.dataset_id === 1);
      },
      successMessage: "POISONED INPUTS IDENTIFIED. Training data corruption is exposed."
    },
    {
      id: "L11_Q7",
      title: "PRIVILEGE ACCUMULATION",
      story: "Zero finds that some actors accumulated influence gradually, never triggering alarms, until they effectively controlled entire realities. Identify such privilege accumulation paths.",
      objective: "Identify actors with privilege accumulation.",
      hint: "Slow escalation avoids detection.",
      tables: [
        {
          name: "actor_roles",
          columns: [
          ...
          data: [
            { id: 1, actor_id: 1, role_id: 1 },
            { id: 2, actor_id: 1, role_id: 2 },
            { id: 3, actor_id: 1, role_id: 3 },
            { id: 4, actor_id: 1, role_id: 4 },
            { id: 5, actor_id: 1, role_id: 5 },
            { id: 6, actor_id: 1, role_id: 6 },
            { id: 7, actor_id: 2, role_id: 1 },
            { id: 8, actor_id: 2, role_id: 2 }
          ]
        }
      ],
      expectedResult: (data) => {
        // Actor 1: has 6 distinct roles (> 5)
        // Actor 2: has 2 distinct roles (not > 5)
        return data.length > 0 && data.some(d => d.actor_id === 1);
      },
      successMessage: "PRIVILEGE ACCUMULATION IDENTIFIED. Gradual escalation paths are exposed."
    },
    {
      id: "L11_Q8",
      title: "FORGED AUDITS",
      story: "Pixel suspects that some audit trails look complete but were constructed after the fact. Identify updates whose audit records were written later than expected.",
      objective: "Identify updates with forged audit trails.",
      hint: "Audits can be forged.",
      tables: [
        {
          name: "updates",
          columns: [
          ...
          data: [
            { update_id: 1, reality_id: 1, end_time: 100 },
            { update_id: 2, reality_id: 2, end_time: 200 }
          ]
        },
        {
          name: "audit_logs",
          columns: [
            { name: "id", type: "number" },
            { name: "update_id", type: "number" },
            { name: "logged_time", type: "number" }
          ],
          data: [
            { id: 1, update_id: 1, logged_time: 400 },
            { id: 2, update_id: 2, logged_time: 210 }
          ]
        }
      ],
      expectedResult: (data) => {
        // Update 1: logged_time 400 > end_time 100 + 5 minutes (300), so > 5 minutes late
        // Update 2: logged_time 210 < end_time 200 + 5 minutes (500), so not late
        return data.length > 0 && data.some(d => d.update_id === 1);
      },
      successMessage: "FORGED AUDITS IDENTIFIED. Delayed audit trails are exposed."
    },
    {
      id: "L11_Q9",
      title: "BIASED DECISIONS",
      story: "Nyx detects realities where isolation and consensus held, yet outcomes were biased by manipulated inputs rather than faulty coordination. Identify such realities.",
      objective: "Identify realities with biased decision models.",
      hint: "The system worked as designed.",
      tables: [
        {
          name: "realities",
          columns: [
        ...
        },
        {
          ...
          columns: [
            { name: "id", type: "number" },
            { name: "update_id", type: "number" },
            { name: "bias_score", type: "number" }
          ],
          data: [
            { id: 1, update_id: 1, bias_score: 0.95 },
            { id: 2, update_id: 2, bias_score: 0.80 }
          ]
        }
      ],
      expectedResult: (data) => {
        // Reality 1: has bias_score 0.95 > 0.9
        return data.length > 0 && data.some(d => d.id === 1);
      },
      successMessage: "BIASED DECISIONS IDENTIFIED. Model bias is exposed."
    },
    {
      id: "L11_Q10",
      title: "COVERT INTEGRITY SWEEP",
      story: "Zero prepares a covert integrity sweep: identify realities where access misuse, subtle data alteration, and delayed auditing all occurred together.",
      objective: "Identify realities with multiple security violations.",
      hint: "Compromise hides in combinations.",
      tables: [
        {
          name: "realities",
          columns: [
        ...
        },
        {
          ...
          data: [
            { update_id: 1, reality_id: 1, actor_id: 1, end_time: 100 },
            { update_id: 2, reality_id: 2, actor_id: 2, end_time: 200 }
          ]
        },
        {
          name: "actor_roles",
      ...
      expectedResult: (data) => {
        // Reality 1: unauthorized modify (can_modify=false), delayed audit (400 > 100 + 300)
        return data.length > 0 && data.some(d => d.id === 1);
      },
      successMessage: "COVERT INTEGRITY SWEEP COMPLETE. Multiple security violations are identified."
    },
    {
      id: "L11_BOSS1",
      title: "BOSS FIGHT: THE TRUST EATER",
      story: "BOSS FIGHT: The Trust Eater corrupts reality not by breaking rules, but by exploiting them. Zero must isolate realities where unauthorized influence, poisoned inputs, delayed audits, and replica divergence all overlap.",
      objective: "Identify realities with all trust violation symptoms.",
      hint: "This is adversarial correctness.",
      tables: [
        {
          name: "realities",
          columns: [
      ...
      expectedResult: (data) => {
        // Reality 1: unauthorized modify, bias_score > 0.9, delayed audit, divergent state_hash
        return data.length > 0 && data.some(d => d.id === 1);
      },
      successMessage: "TRUST EATER WEAKENED. Trust violations are collapsing.\n\nNYX: 'The eater is losing its power source.'"
    },
    {
      id: "L11_BOSS2",
      title: "FINAL BOSS: THE INVISIBLE ADVERSARY",
      story: "FINAL BOSS: The Invisible Adversary bends reality without breaking any guarantees. Zero must identify realities where privilege accumulation, supply-chain poisoning, biased decision models, forged audits, and delayed detection combined to permanently alter outcomes.",
      objective: "Identify realities with all adversarial symptoms.",
      hint: "This is the limit of trust.",
      tables: [
        {
          name: "realities",
          columns: [
        ...
        },
        {
          ...
          data: [
            { update_id: 1, reality_id: 1, actor_id: 1, source_component: 1, end_time: 100 },
            { update_id: 2, reality_id: 2, actor_id: 2, source_component: 2, end_time: 200 }
          ]
        },
        {
          name: "actor_roles",
      ...
      expectedResult: (data) => {
        // Reality 1: actor 1 has 6 roles (> 5), has supply chain component, bias_score > 0.9, delayed audit
        return data.length > 0 && data.some(d => d.id === 1);
      },
      successMessage: "INVISIBLE ADVERSARY DESTROYED. The security layer is stabilized.\n\nZERO: 'The adversary... trust boundaries are restored.'\n\nLEVEL COMPLETE. SECURITY VISION UNLOCKED."
    }
  ]
};
  ...
  missions: [
    {
      id: "L12_Q1",
      title: "CATASTROPHIC SLOWDOWN",
      story: "Zero inspects realities where massive transformations slowed catastrophically as population grew. The slowdown followed structural depth rather than record count, worsened under concurrency, and coincided with silent shortcut failure. Identify such realities.",
      objective: "Identify realities with catastrophic performance degradation.",
      hint: "Depth multiplies under load.",
      tables: [
        {
          name: "realities",
          columns: [
        ...
        },
        {
          ...
          data: [
            { plan_id: 1, query_id: 1 },
            { plan_id: 2, query_id: 2 }
          ]
        },
        {
          name: "index_stats",
        ...
        },
        {
          name: "buffer_pool_stats",
          columns: [
            { name: "stat_id", type: "number" },
            { name: "query_id", type: "number" },
            { name: "cache_evictions", type: "number" }
          ],
          data: [
            { stat_id: 1, query_id: 1, cache_evictions: 10 },
            { stat_id: 2, query_id: 2, cache_evictions: 0 }
          ]
        },
        {
          name: "read_logs",
          ...
          data: [
            { read_id: 1, reality_id: 1 },
            { read_id: 2, reality_id: 2 }
          ]
        },
        {
          name: "durability_logs",
        ...
        },
        {
          ...
          data: [
            { id: 1, role_id: 1, can_modify: true },
            { id: 2, role_id: 2, can_modify: false }
          ]
        },
        {
          name: "audit_logs",
      ...
      expectedResult: (data) => {
        // Reality 1: tree_height 5 > 4, used_index false, concurrent_executions 15 > 10, cache_evictions > 0, can_modify true, has audit
        return data.length > 0 && data.some(d => d.id === 1);
      },
      successMessage: "CATASTROPHIC SLOWDOWN IDENTIFIED. Performance collapse is exposed."
    },
    {
      id: "L12_Q2",
      title: "UNRECOVERABLE REALITIES",
      story: "Zero finds realities where an attempted recovery caused deeper corruption. Partial reversals interacted with concurrent changes, leaving structural scars across storage and replicas. Identify such unrecoverable realities.",
      objective: "Identify unrecoverable realities.",
      hint: "Undo can destroy more than change.",
      tables: [
        {
          name: "realities",
          columns: [
        ...
        },
        {
          ...
          data: [
            { id: 1, update_id: 1, steps_rolled_back: 2 },
            { id: 2, update_id: 2, steps_rolled_back: 3 }
          ]
        },
        {
          name: "update_steps",
        ...
        },
        {
          ...
          columns: [
            { name: "id", type: "number" },
            { name: "reality_id", type: "number" },
            { name: "partition_count", type: "number" }
          ],
          data: [
            { id: 1, reality_id: 1, partition_count: 1 },
            { id: 2, reality_id: 2, partition_count: 0 }
          ]
        },
        {
          name: "durability_logs",
      ...
      expectedResult: (data) => {
        // Reality 1: steps_rolled_back 2 < total steps 3, page 1 has no checksum, partition_count > 0
        return data.length > 0 && data.some(d => d.id === 1);
      },
      successMessage: "UNRECOVERABLE REALITIES IDENTIFIED. Recovery failures are exposed."
    },
    {
      id: "L12_Q3",
      title: "DECEPTIVE ISOLATION",
      story: "The Council asks Zero to identify realities where correctness, durability, and consensus all held, yet performance degradation silently broke isolation guarantees under pressure. Identify these deceptive realities.",
      objective: "Identify realities with broken isolation guarantees.",
      hint: "Performance can violate truth.",
      tables: [
        {
          name: "realities",
          columns: [
        ...
        },
        {
          ...
          data: [
            { update_id: 1, reality_id: 1, start_time: 100, end_time: 200 },
            { update_id: 2, reality_id: 2, start_time: 300, end_time: 400 }
          ]
        },
        {
          name: "read_logs",
          ...
          data: [
            { read_id: 1, reality_id: 1, read_time: 150 },
            { read_id: 2, reality_id: 2, read_time: 500 }
          ]
        },
        {
          name: "query_logs",
          ...
          data: [
            { query_id: 1, reality_id: 1, index_id: 1 },
            { query_id: 2, reality_id: 2, index_id: 2 }
          ]
        },
        {
          name: "buffer_pool_stats",
          ...
          data: [
            { stat_id: 1, query_id: 1, cache_evictions: 5 },
            { stat_id: 2, query_id: 2, cache_evictions: 0 }
          ]
        },
        {
      ...
      expectedResult: (data) => {
        // Reality 1: read_time 150 between start 100 and end 200, tree_height 4 > 3, cache_evictions > 0, ack_time 150 < end_time 200
        return data.length > 0 && data.some(d => d.id === 1);
      },
      successMessage: "DECEPTIVE ISOLATION IDENTIFIED. Performance-induced violations are exposed."
    },
    {
      id: "L12_Q4",
      title: "FRACTURED RECOVERIES",
      story: "Zero isolates realities that survived crashes but recovered into inconsistent states because history replay interacted with concurrent rollbacks and planner misjudgment. Identify such fractured recoveries.",
      objective: "Identify realities with fractured recoveries.",
      hint: "Recovery is execution too.",
      tables: [
        {
          name: "realities",
          columns: [
        ...
        },
        {
          ...
          data: [
            { id: 1, reality_id: 1, start_time: 200 },
            { id: 2, reality_id: 2, start_time: 300 }
          ]
        },
        {
          name: "wal_records",
        ...
        },
        {
          ...
          data: [
            { id: 1, update_id: 1, steps_rolled_back: 2 },
            { id: 2, update_id: 2, steps_rolled_back: 0 }
          ]
        },
        {
          name: "query_plans",
      ...
      expectedResult: (data) => {
        // Reality 1: has rollback (steps_rolled_back > 0), ack_time 150 < crash start 200, has divergent state_hash
        return data.length > 0 && data.some(d => d.id === 1);
      },
      successMessage: "FRACTURED RECOVERIES IDENTIFIED. Recovery inconsistencies are exposed."
    },
    {
      id: "L12_Q5",
      title: "SILENT INDEX FAILURE",
      story: "Zero must identify realities where indexing structures existed but silently stopped helping due to data drift, type mismatches, and planner poisoning — all while returning correct answers. Identify such realities.",
      objective: "Identify realities with silent index failures.",
      hint: "Correct answers can still be deadly.",
      tables: [
        {
          name: "realities",
          columns: [
        ...
        },
        {
          ...
          data: [
            { query_id: 1, reality_id: 1, index_id: 1, used_index: false },
            { query_id: 2, reality_id: 2, index_id: 2, used_index: true }
          ]
        },
        {
          name: "index_stats",
        ...
        },
        {
          ...
          data: [
            { id: 1, query_id: 1, expression_type: "CAST" },
            { id: 2, query_id: 2, expression_type: "COLUMN" }
          ]
        },
        {
          name: "query_plans",
          ...
          data: [
            { plan_id: 1, query_id: 1, plan_age: 1000, statistics_refresh_interval: 500 },
            { plan_id: 2, query_id: 2, plan_age: 200, statistics_refresh_interval: 500 }
          ]
        },
        {
          name: "buffer_pool_stats",
      ...
      expectedResult: (data) => {
        // Reality 1: used_index false, expression_type CAST, plan_age 1000 > refresh_interval 500, cache_evictions > 0
        return data.length > 0 && data.some(d => d.id === 1);
      },
      successMessage: "SILENT INDEX FAILURE IDENTIFIED. Index degradation is exposed."
    },
    {
      id: "L12_Q6",
      title: "AGREEMENT WITHOUT COORDINATION",
      story: "Zero detects realities where distributed agreement succeeded, but uniqueness guarantees were violated due to concurrent acceptance under partition and later reconciliation. Identify such realities.",
      objective: "Identify realities with uniqueness violations despite agreement.",
      hint: "Agreement without coordination lies.",
      tables: [
        {
          name: "realities",
          columns: [
        ...
        },
        {
          ...
          data: [
            { id: 1, reality_id: 1, replica_id: 1, update_id: 1 },
            { id: 2, reality_id: 1, replica_id: 2, update_id: 2 },
            { id: 3, reality_id: 2, replica_id: 1, update_id: 3 }
          ]
        },
        {
          name: "network_partitions",
        ...
        },
        {
          ...
          data: [
            { id: 1, reality_id: 1, unique_key: "key1" },
            { id: 2, reality_id: 2, unique_key: "key2" }
          ]
        },
        {
          name: "durability_logs",
      ...
      expectedResult: (data) => {
        // Reality 1: has 2 different replicas for same unique_key
        return data.length > 0 && data.some(d => d.id === 1);
      },
      successMessage: "AGREEMENT WITHOUT COORDINATION IDENTIFIED. Uniqueness violations are exposed."
    },
    {
      id: "L12_Q7",
      title: "RARE COMBINATION COLLAPSE",
      story: "Zero uncovers realities where storage pressure, deep structure traversal, and concurrency amplified each other into a collapse invisible in testing. Identify such realities.",
      objective: "Identify realities with rare combination collapses.",
      hint: "Rare combinations kill systems.",
      tables: [
        {
          name: "realities",
          columns: [
        ...
        },
        {
          ...
          data: [
            { query_id: 1, reality_id: 1, index_id: 1, concurrent_executions: 20 },
            { query_id: 2, reality_id: 2, index_id: 2, concurrent_executions: 10 }
          ]
        },
        {
          name: "index_stats",
      ...
      expectedResult: (data) => {
        // Reality 1: tree_height 5 > 4, cache_evictions > 0, concurrent_executions 20 > 15
        return data.length > 0 && data.some(d => d.id === 1);
      },
      successMessage: "RARE COMBINATION COLLAPSE IDENTIFIED. System failures are exposed."
    },
    {
      id: "L12_Q8",
      title: "SLOW TRUST EROSION",
      story: "Zero identifies realities where long-term privilege accumulation enabled subtle outcome manipulation without breaking any rule or trigger. Identify such realities.",
      objective: "Identify realities with slow trust erosion.",
      hint: "Trust erodes slowly.",
      tables: [
        {
          name: "realities",
          columns: [
        ...
        },
        {
          ...
          data: [
            ...
            { id: 5, actor_id: 1, role_id: 5 },
            { id: 6, actor_id: 1, role_id: 6 },
            { id: 7, actor_id: 1, role_id: 7 },
            { id: 8, actor_id: 2, role_id: 1 }
          ]
        },
        {
          name: "role_permissions",
        ...
        },
        {
          ...
          data: [
            { id: 1, update_id: 1, bias_score: 0.90 },
            { id: 2, update_id: 2, bias_score: 0.70 }
          ]
        },
        {
          name: "audit_logs",
      ...
      expectedResult: (data) => {
        // Reality 1: actor 1 has 7 roles (> 6), avg bias_score 0.90 > 0.85
        return data.length > 0 && data.some(d => d.id === 1);
      },
      successMessage: "SLOW TRUST EROSION IDENTIFIED. Privilege accumulation is exposed."
    },
    {
      id: "L12_Q9",
      title: "EXACTLY-ONCE ILLUSIONS",
      story: "Zero must locate realities where retries, partial reversals, and concurrency created exactly-once illusions that permanently diverged state. Identify them.",
      objective: "Identify realities with exactly-once illusions.",
      hint: "Once is a myth.",
      tables: [
        {
          name: "realities",
        ...
        },
        {
          ...
          data: [
            { id: 1, reality_id: 1, update_id: 1, state_hash: "hash1" },
            { id: 2, reality_id: 1, update_id: 1, state_hash: "hash2" },
            { id: 3, reality_id: 2, update_id: 2, state_hash: "hash3" }
          ]
        },
        {
          name: "rollback_logs",
      ...
      expectedResult: (data) => {
        // Reality 1: has 2 different state_hash values for same update
        return data.length > 0 && data.some(d => d.id === 1);
      },
      successMessage: "EXACTLY-ONCE ILLUSIONS IDENTIFIED. State divergence is exposed."
    },
    {
      id: "L12_Q10",
      title: "GOVERNANCE VIOLATIONS",
      story: "Zero prepares the final audit: identify realities where every subsystem behaved as designed, yet the final outcome violated governance constraints defined long ago.",
      objective: "Identify realities with governance violations.",
      hint: "Correct does not mean right.",
      tables: [
        {
          name: "realities",
          columns: [
          ...
          data: [
            { id: 1, reality_name: "Reality_A", policy_id: 1 },
            { id: 2, reality_name: "Reality_B", policy_id: 2 }
          ]
        },
        {
        ...
        },
        {
          ...
          columns: [
            { name: "id", type: "number" },
            { name: "policy_id", type: "number" },
            { name: "allowed_outcome", type: "string" }
          ],
          data: [
            { id: 1, policy_id: 1, allowed_outcome: "APPROVED" },
            { id: 2, policy_id: 1, allowed_outcome: "PENDING" },
            { id: 3, policy_id: 2, allowed_outcome: "REJECTED" }
          ]
        },
        {
          name: "updates",
        ...
        },
        {
          ...
          data: [
            { id: 1, update_id: 1, decision_outcome: "REJECTED" },
            { id: 2, update_id: 2, decision_outcome: "REJECTED" }
          ]
        },
        {
          name: "audit_logs",
      ...
      expectedResult: (data) => {
        // Reality 1: decision_outcome REJECTED not in allowed outcomes (APPROVED, PENDING)
        return data.length > 0 && data.some(d => d.id === 1);
      },
      successMessage: "GOVERNANCE VIOLATIONS IDENTIFIED. Policy violations are exposed."
    },
    {
      id: "L12_BOSS1",
      title: "CREATOR BOSS: THE IRREVERSIBLE ACT",
      story: "CREATOR BOSS: Zero faces the irreversible act. Identify realities where rollback, recovery, or optimization would amplify corruption due to interacting failures across depth, concurrency, storage, distribution, and trust.",
      objective: "Identify realities that must be sealed.",
      hint: "Some worlds must be sealed.",
      tables: [
        {
          name: "realities",
          columns: [
      ...
      expectedResult: (data) => {
        // Reality 1: no checksum for page 1, tree_height 5 > 4, cache_evictions > 0, actor has 6 roles (> 5), bias_score > 0.9
        return data.length > 0 && data.some(d => d.id === 1);
      },
      successMessage: "IRREVERSIBLE ACT IDENTIFIED. Some realities must be sealed.\n\nNYX: 'Some worlds cannot be saved.'"
    },
    {
      id: "L12_BOSS2",
      title: "CREATOR BOSS: THE FINAL CHOICE",
      story: "CREATOR BOSS: The Final Choice. Zero must determine which realities are allowed to exist in the new architecture. Identify realities provably safe across structure depth, rollback integrity, storage durability, distribution, performance, security, and governance — and eliminate all others.",
      objective: "Identify realities safe for the new architecture.",
      hint: "This choice defines the future.",
      tables: [
        {
          name: "realities",
          columns: [
        ...
        },
        {
          ...
          data: [
            { id: 1, reality_id: 1, state_hash: "hash1" },
            { id: 2, reality_id: 2, state_hash: null }
          ]
        },
        {
          name: "network_partitions",
      ...
      expectedResult: (data) => {
        // Reality 2: no rollback, has checksum, no state_hash, no partition, tree_height 2 <= 4, no cache_evictions, can_modify true, bias_score 0.70 < 0.8
        // Reality 1: has rollback, no checksum for page 1, has state_hash, has partition, tree_height 5 > 4, cache_evictions > 0, can_modify false, bias_score > 0.8
        // So Reality 2 should be safe (not in the exclusion list)
        return data.length > 0 && data.some(d => d.id === 2);
      },
      successMessage: "THE FINAL CHOICE MADE. The new architecture is defined.\n\nZERO: 'Only the safe realities remain.'\n\nNYX: 'You are the Architect now.'\n\nCONGRATULATIONS. YOU HAVE BEATEN THE GAME."
    }
  ]
};
